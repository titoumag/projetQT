...
QT_MOC_LITERAL(1, 10, 18), // "vers_IHM_connexion"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 15), // "coupJoueeReseau"
QT_MOC_LITERAL(4, 46, 10), // "recoitCoup"
QT_MOC_LITERAL(5, 57, 12), // "connexion_OK"
QT_MOC_LITERAL(6, 70, 12), // "erreurSocket"
QT_MOC_LITERAL(7, 83, 28) // "QAbstractSocket::SocketError"

    },
    "ClientTcp\0vers_IHM_connexion\0\0"
    "coupJoueeReseau\0recoitCoup\0connexion_OK\0"
    "erreurSocket\0QAbstractSocket::SocketError"
};
...
void ClientTcp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->recoitCoup(); break;
        case 3: _t->connexion_OK(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientTcp::vers_IHM_connexion)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ClientTcp::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ClientTcp::coupJoueeReseau)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ClientTcp::vers_IHM_connexion()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ClientTcp::coupJoueeReseau(int _t1)
{
